...
Route::group(['prefix' => 'good'], function () {
	...
	Route::get('/zeroStock/{main_category_id}/{category_id}/{location}/{distributor_id}/{stock}', 'GoodController@zeroStock');
    ...
    Route::post('/{good_id}/changeDist', 'GoodController@changeDist')->name('good.changeDist');
	Route::get('/{category_id}/{type_id}/{distributor_id}/{sort}/{order}/{pagination}', 'GoodController@index');
});
