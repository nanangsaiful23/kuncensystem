            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                @if(\Auth::user()->email == 'admin')
                  ...
                  <th class="center">Total Transaksi Akhir</th>
