          ...
          <div class="box-body" style="overflow-x:scroll; color: black !important">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th style="background-color: #E5F9DB">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debet/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debet/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> Debet</a></th>
