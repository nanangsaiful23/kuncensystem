          ...
          <div class="box-body" style="overflow-x:scroll; color: black !important">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th width="15%">Tipe</th>
                <th width="10%">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/id/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/id/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> Journal ID</a></th>
                <th width="10%">Tipe ID</th>
                <th width="10%">Created_at</th>
                <th width="10%">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/journal_date/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/journal_date/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> Tanggal</a></th>
                <th>Nama</th>
                <th style="background-color: #E5F9DB">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debit_account_id/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debit_account_id/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> No Akun</a></th>
                <th style="background-color: #E5F9DB">Akun</th>
                <th style="background-color: #E5F9DB">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debit/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/debit/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> Debet</a></th>
                <th style="background-color: #FFABAB">@if($order == 'desc')<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/credit_account_id/asc/' . $pagination) }}">@else<a href="{{ url($role . '/journal/' . $code . '/' . $type . '/' . $start_date . '/' . $end_date . '/credit_account_id/asc/' . $pagination) }}">@endif <i class="fa fa-sort" aria-hidden="true"></i> No Akun</a></th>
