...
<div class="panel-body">
    <div class="row">
       <div class="col-sm-7">
            {!! Form::label('address', 'Alamat Web Transfer', array('class' => 'col-sm-3 left control-label')) !!}
            <div class="col-sm-9">
                ...
                <tbody id="table-transaction">
                    ...
                    <tr id="row-data-{{ $i }}">
                        ...
                        <td @if(\Auth::user()->role != 'supervisor') style="display: none" @endif>
                             <textarea type="text" name="prices[]" class="form-control" id="price-{{ $i }}"></textarea>
                        </td>
                        <td @if(\Auth::user()->role != 'supervisor') style="display: none" @endif>
    ...
    <div onclick="event.preventDefault(); submitForm();" class='btn btn-success btn-flat btn-block form-control'>Proses Transfer</div>
