        ...
        @if(\Auth::user()->role == 'supervisor')
          ...
          <li class="treeview {{ (Request::segment(2) == 'distributor' ) ? 'active' : ''  }}">
            ...
            <ul class="treeview-menu">
                ...
                <li class="{{ Request::segment(2) == 'distributor' && Request::segment(3) != 'create' ? 'active' : ''  }}"><a href="{{ url('/' . $role . '/distributor/20') }}"><i class="fa fa-circle-o"></i> Daftar Distributor</a></li>
            </ul>
          </li>
